...
const page = 'fill-online/get-your-national-insurance-number-by-post/when-did-you-start-working-for-employer';
const pageTitleEN = 'When did you start working for your employer?'; // see below
const pageTitleCY = '';
const env = require('../../fixtures/env.json');
const user = require('../../fixtures/user.json');
const { terminalLog } = require('../../plugins/hmrc');

// whenDidYouStartWorkingForEmployer.title = When did you start working for your employer?
// whenDidYouStartWorkingForEmployer.heading = When did you start working for {0}?
...
const route = 'when-did-you-start-working-for-employer';
...
describe(`Page:: ${pageTitleEN}`, () => {
  ...
  describe('Go to the next page', () => {
    it('submits the form', () => {
      ...
      // NEXT_PAGE: (check employment history loop)
