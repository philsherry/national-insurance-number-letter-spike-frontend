...
const page = 'fill-online/get-your-national-insurance-number-by-post/are-you-sure-you-want-to-remove-previous-name';
const pageTitleEN = 'Are you sure you want to remove this name?'; // see below
const pageTitleCY = '';
const env = require('../../fixtures/env.json');
const user = require('../../fixtures/user.json');
const { terminalLog } = require('../../plugins/hmrc');

// areYouSureYouWantToRemovePreviousName.title = Are you sure you want to remove this name?
// areYouSureYouWantToRemovePreviousName.heading = Are you sure you want to remove "{0}"?
...
const route = 'are-you-sure-you-want-to-remove-previous-name';
