...
const page = 'fill-online/get-your-national-insurance-number-by-post/current-relationship-type';
const pageTitleEN =
  'Is your current relationship a marriage or civil partnership?';
const pageTitleCY = '';
...
const route = 'current-relationship-type';
