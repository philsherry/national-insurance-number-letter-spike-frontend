...
const page = 'fill-online/get-your-national-insurance-number-by-post/have-you-ever-claimed-child-benefit';
const pageTitleEN = 'Have you ever claimed Child Benefit?';
const pageTitleCY = '';
...
const route = 'have-you-ever-claimed-child-benefit';
...
describe(`Page:: ${pageTitleEN}`, () => {
  ...
  describe('Go to the next page', () => {
    it('submits the form', () => {
      ...
      // NEXT_PAGE: do-you-know-your-child-benefit-number
