...
const page = 'fill-online/get-your-national-insurance-number-by-post/is-your-previous-address-in-uk';
const pageTitleEN = 'Is your previous home address in the UK?';
const pageTitleCY = '';
...
const route = 'is-your-previous-address-in-uk';
...
describe(`Page:: ${pageTitleEN}`, () => {
  ...
  describe('Go to the next page', () => {
    it('submits the form', () => {
      ...
      // NEXT_PAGE: what-is-your-previous-address-uk
