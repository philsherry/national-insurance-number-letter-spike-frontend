...
const page = 'fill-online/get-your-national-insurance-number-by-post/journey-recovery-start-again';
const pageTitleEN = 'CHANGE_THIS_PAGE_TITLE';
const pageTitleCY = '';
...
const route = 'journey-recovery-start-again';
