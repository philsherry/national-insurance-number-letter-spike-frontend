...
const page = 'fill-online/get-your-national-insurance-number-by-post/do-you-have-primary-document';
const pageTitleEN = 'Do you have one of the following identity documents?';
const pageTitleCY = '';
...
const route = 'do-you-have-primary-document';
