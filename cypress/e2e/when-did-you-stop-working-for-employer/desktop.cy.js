...
const page = 'fill-online/get-your-national-insurance-number-by-post/when-did-you-stop-working-for-employer';
const pageTitleEN = 'When did you stop working for your employer?'; // see below
const pageTitleCY = '';
const env = require('../../fixtures/env.json');
const user = require('../../fixtures/user.json');
const { terminalLog } = require('../../plugins/hmrc');

// whenDidYouStopWorkingForEmployer.title = When did you stop working for your employer?
// whenDidYouStopWorkingForEmployer.heading = When did you stop working for {0}?
...
const route = 'when-did-you-stop-working-for-employer';
