...
const page = 'fill-online/get-your-national-insurance-number-by-post/do-you-know-your-child-benefit-number';
const pageTitleEN = 'Do you know your Child Benefit number?';
const pageTitleCY = '';
...
const route = 'do-you-know-your-child-benefit-number';
...
describe(`Page:: ${pageTitleEN}`, () => {
  ...
  describe('Go to the next page', () => {
    it('submits the form', () => {
      ...
      // NEXT_PAGE: what-is-your-national-insurance-number
