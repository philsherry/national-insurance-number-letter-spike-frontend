...
const page = 'fill-online/get-your-national-insurance-number-by-post/what-other-uk-benefits-have-you-received';
const pageTitleEN = 'What other UK benefits have you received?';
const pageTitleCY = '';
...
const route = 'what-other-uk-benefits-have-you-received';
...
describe(`Page:: ${pageTitleEN}`, () => {
  ...
  describe('Go to the next page', () => {
    it('submits the form', () => {
      ...
      // NEXT_PAGE: have-you-ever-worked-in-uk
