...
const page = 'fill-online/get-your-national-insurance-number-by-post/previous-marriage-or-partnership-details';
const pageTitleEN =
  'When were you previously in a marriage or civil partnership?';
const pageTitleCY = '';
...
const route = 'previous-marriage-or-partnership-details';
...
describe(`Page:: ${pageTitleEN}`, () => {
  ...
  describe('Go to the next page', () => {
    it('submits the form', () => {
      ...
      // NEXT_PAGE: have-you-ever-claimed-child-benefit
