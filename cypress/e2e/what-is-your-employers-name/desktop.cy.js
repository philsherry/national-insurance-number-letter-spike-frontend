...
const page = 'fill-online/get-your-national-insurance-number-by-post/what-is-your-employers-name';
const pageTitleEN = 'What is your employer’s name?';
const pageTitleCY = '';
...
const route = 'what-is-your-employers-name';
...
describe(`Page:: ${pageTitleEN}`, () => {
  ...
  describe('Go to the next page', () => {
    it('submits the form', () => {
      ...
      // NEXT_PAGE: what-is-your-employers-address
