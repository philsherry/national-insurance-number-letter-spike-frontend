...
const page = 'fill-online/get-your-national-insurance-number-by-post/what-is-your-telephone-number';
const pageTitleEN = 'What is your telephone number?';
const pageTitleCY = '';
...
const route = 'what-is-your-telephone-number';
...
describe(`Page:: ${pageTitleEN}`, () => {
  ...
  describe('Go to the next page', () => {
    it('submits the form', () => {
      ...
      // NEXT_PAGE: do-you-know-your-national-insurance-number
