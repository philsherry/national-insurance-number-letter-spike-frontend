...
const page = 'fill-online/get-your-national-insurance-number-by-post/are-you-sure-you-want-to-remove-employer';
const pageTitleEN = 'Are you sure you want to remove this employer?'; // see below
const pageTitleCY = '';
const env = require('../../fixtures/env.json');
const user = require('../../fixtures/user.json');
const { terminalLog } = require('../../plugins/hmrc');

// areYouSureYouWantToRemoveEmployer.title = Are you sure you want to remove this employer?
// areYouSureYouWantToRemoveEmployer.heading = Are you sure you want to remove {0}?
...
const route = 'are-you-sure-you-want-to-remove-employer';
