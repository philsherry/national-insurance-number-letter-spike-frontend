...
const page = 'fill-online/get-your-national-insurance-number-by-post/do-you-have-any-previous-addresses';
const pageTitleEN = 'Do you have any previous home addresses?';
const pageTitleCY = '';
...
const route = 'do-you-have-any-previous-addresses';
...
describe(`Page:: ${pageTitleEN}`, () => {
  ...
  describe('Go to the next page', () => {
    it('submits the form', () => {
      ...
      // NEXT_PAGE: is-your-previous-address-in-uk
