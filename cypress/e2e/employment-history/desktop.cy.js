...
const page = 'fill-online/get-your-national-insurance-number-by-post/employment-history';
const pageTitleEN = 'You have added no employers'; // see below
const pageTitleCY = '';
const env = require('../../fixtures/env.json');
const user = require('../../fixtures/user.json');
const { terminalLog } = require('../../plugins/hmrc');

// employmentHistory.heading.none = You have added no employers
// employmentHistory.heading.one = You have added 1 employer
// employmentHistory.heading.many = You have added {0} employers
...
const route = 'employment-history';
