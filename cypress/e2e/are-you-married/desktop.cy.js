...
const page = 'fill-online/get-your-national-insurance-number-by-post/are-you-married';
const pageTitleEN = 'Are you married or in a civil partnership?';
const pageTitleCY = '';
...
describe(`Page:: ${pageTitleEN}`, () => {
  ...
  describe('Go to the next page', () => {
    it('submits the form', () => {
      ...
      // NEXT_PAGE: have-you-previously-been-in-a-marriage-or-civil-partnership
