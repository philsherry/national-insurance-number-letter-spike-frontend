...
const page = 'fill-online/get-your-national-insurance-number-by-post/have-you-ever-received-other-uk-benefits';
const pageTitleEN = 'Have you ever received any other UK benefits?';
const pageTitleCY = '';
...
const route = 'have-you-ever-received-other-uk-benefits';
...
describe(`Page:: ${pageTitleEN}`, () => {
  ...
  describe('Go to the next page', () => {
    it('submits the form', () => {
      ...
      // NEXT_PAGE: what-other-uk-benefits-have-you-received
