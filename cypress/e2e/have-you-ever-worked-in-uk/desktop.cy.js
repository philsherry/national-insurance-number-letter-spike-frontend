...
const page = 'fill-online/get-your-national-insurance-number-by-post/have-you-ever-worked-in-uk';
const pageTitleEN = 'Have you ever worked in the UK?';
const pageTitleCY = '';
...
const route = 'have-you-ever-worked-in-uk';
...
describe(`Page:: ${pageTitleEN}`, () => {
  ...
  describe('Go to the next page', () => {
    it('submits the form', () => {
      ...
      // NEXT_PAGE: what-is-your-employers-name
