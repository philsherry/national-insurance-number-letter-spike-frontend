...
const page = 'fill-online/get-your-national-insurance-number-by-post/what-is-your-current-address-uk';
const pageTitleEN = 'Is your current home address in the UK?';
const pageTitleCY = '';
...
const route = 'what-is-your-current-address-uk';
...
describe(`Page:: ${pageTitleEN}`, () => {
  ...
  describe('Go to the next page', () => {
    it('submits the form', () => {
      ...
      // NEXT_PAGE: do-you-have-any-previous-addresses
