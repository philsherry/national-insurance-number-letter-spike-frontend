...
const page = 'fill-online/get-your-national-insurance-number-by-post/what-is-your-employers-address';
const pageTitleEN = 'What is your employer’s address?'; // see below
const pageTitleCY = '';
const env = require('../../fixtures/env.json');
const user = require('../../fixtures/user.json');
const { terminalLog } = require('../../plugins/hmrc');

// whatIsYourEmployersAddress.title = What is your employer’s address?
// whatIsYourEmployersAddress.heading = What is {0}’s address?
...
const route = 'what-is-your-employers-address';
...
describe(`Page:: ${pageTitleEN}`, () => {
  ...
  describe('Go to the next page', () => {
    it('submits the form', () => {
      ...
      // NEXT_PAGE: when-did-you-start-working-for-employer
