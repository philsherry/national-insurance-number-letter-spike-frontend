...
const page = 'fill-online/get-your-national-insurance-number-by-post/what-is-your-child-benefit-number';
const pageTitleEN = 'What is your Child Benefit number?';
const pageTitleCY = '';
...
const route = 'what-is-your-child-benefit-number';
...
describe(`Page:: ${pageTitleEN}`, () => {
  ...
  describe('Go to the next page', () => {
    it('submits the form', () => {
      ...
      // NEXT_PAGE: have-you-ever-received-other-uk-benefits
