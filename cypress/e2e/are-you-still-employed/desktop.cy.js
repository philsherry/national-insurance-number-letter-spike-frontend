...
const page = 'fill-online/get-your-national-insurance-number-by-post/are-you-still-employed';
const pageTitleEN = 'Are you still employed by your employer?'; // see below
const pageTitleCY = '';
const env = require('../../fixtures/env.json');
const user = require('../../fixtures/user.json');
const { terminalLog } = require('../../plugins/hmrc');

// areYouStillEmployed.title = Are you still employed by your employer?
// areYouStillEmployed.heading = Are you still employed by {0}?
...
const route = 'are-you-still-employed';
