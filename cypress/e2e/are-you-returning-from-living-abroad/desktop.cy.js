...
const page = 'fill-online/get-your-national-insurance-number-by-post/are-you-returning-from-living-abroad';
const pageTitleEN = 'Are you returning to the UK from living abroad?';
const pageTitleCY = '';
...
const route = 'are-you-returning-from-living-abroad';
...
describe(`Page:: ${pageTitleEN}`, () => {
  ...
  describe('Go to the next page', () => {
    it('submits the form', () => {
      ...
      // NEXT_PAGE: what-is-your-telephone-number
