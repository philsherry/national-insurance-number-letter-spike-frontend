...
class AreYouSureYouWantToRemovePreviousAddressControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val areYouSureYouWantToRemovePreviousAddressRoute = routes.AreYouSureYouWantToRemovePreviousAddressController.onPageLoad(NormalMode).url
  ...
  "AreYouSureYouWantToRemovePreviousAddress Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(AreYouSureYouWantToRemovePreviousAddressPage, true).success.value
