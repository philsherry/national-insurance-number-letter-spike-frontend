...
class AreYouSureYouWantToRemovePreviousRelationshipControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val areYouSureYouWantToRemovePreviousRelationshipRoute = routes.AreYouSureYouWantToRemovePreviousRelationshipController.onPageLoad(NormalMode).url
  ...
  "AreYouSureYouWantToRemovePreviousRelationship Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(AreYouSureYouWantToRemovePreviousRelationshipPage, true).success.value
