...
class WhenDidYouStartWorkingForPreviousEmployerControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val whenDidYouStartWorkingForPreviousEmployerRoute = routes.WhenDidYouStartWorkingForPreviousEmployerController.onPageLoad(NormalMode).url
  ...
  "WhenDidYouStartWorkingForPreviousEmployer Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(WhenDidYouStartWorkingForPreviousEmployerPage, validAnswer).success.value
