...
class WhatIsYourCurrentAddressUkControllerSpec extends SpecBase with MockitoSugar {

  def onwardRoute = Call("GET", "/foo")

  val formProvider = new WhatIsYourCurrentAddressUkFormProvider()
  ...
  "WhatIsYourCurrentAddressUk Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, whatIsYourCurrentAddressUkRoute)

        val view = application.injector.instanceOf[WhatIsYourCurrentAddressUkView]
